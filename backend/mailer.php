...
function sendVerificationEmail($email, $code) {
    $config = Configuration::getDefaultConfiguration()
        ->setApiKey('api-key', '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');
    ...
    $sendSmtpEmail['sender'] = ['name' => 'Your Website Name', 'email' => 'blazingaustin@gmail.com'];
